...
onBeforeMount(async ()=>{
  product.value = await  useFetch(`/api/prisma/get-products-by-id/${route.params.id}`)
        ...
        <div class="md:w-[60%] bg-white p-3 rounded-lg">
          ...
          <div class="flex items-center pt-1.5">
               <span class="h-4 min-w-4 rounded-full p-0.5 bg-[#FFD000] mr-2">
                 <Icon class="-mt-[17px]" name="material-symbols:star-rate" size="12"/>
               </span>
            <p class="text-[#ff5353]">
              Extra 5% off
            </p>
          ...
          <div class="flex items-center justify-start my-2">
            <Icon color="#ff5353" name="ic:baseline-star" size="12"/>
            <Icon color="#ff5353" name="ic:baseline-star" size="12"/>
            <Icon color="#ff5353" name="ic:baseline-star" size="12"/>
            <Icon color="#ff5353" name="ic:baseline-star" size="12"/>
            <Icon color="#ff5353" name="ic:baseline-star" size="12"/>
