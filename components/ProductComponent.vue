    ...
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetail">
        <span class="flex items-center justify-start gap-3 px-1 pt-1">
          ...
          <span class="text-gray-400 text-sm text-light line-through">
             ${{ oldPriceComputed }}
          </span>
        </span>
        ...
        <p class="flex items-center px-1 pt-0.5 text-sm text-[#252525]">
          5,0000+ sold  <Icon name="material-symbols:star-rate" color="#757575"/>4.7
        </p>
